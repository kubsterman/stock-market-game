...
class AsarPackager {
    ...
    async createPackageFromFiles(fileSet, packager) {
        ...
        const fileCopier = new builder_util_2.FileCopier();
        ...
        for (let i = 0, n = fileSet.files.length; i < n; i++) {
            ...
            if (isUnpacked) {
                ...
                if (taskManager.tasks.length > builder_util_2.MAX_FILE_REQUESTS) {
    ...
    writeAsarFile(fileSets, unpackedFileIndexMap) {
        return new Promise((resolve, reject) => {
            ...
            const writeStream = (0, fs_1.createWriteStream)(this.outFile);
                ...
                while (true) {
                    ...
                    if (!unpackedFileIndexSet.has(index)) {
                        ...
                        if (stat != null && stat.isSymbolicLink()) {
                            (0, fs_1.symlink)(stat.linkRelativeToFile, path.join(this.unpackedDest, stat.pathInArchive), () => w(index + 1));
                            return;
                        }
                    }
                    index++;
