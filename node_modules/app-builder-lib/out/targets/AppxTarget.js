...
class AppXTarget extends core_1.Target {
    ...
    async build(appOutDir, arch) {
        ...
        const mappingList = [];
        mappingList.push(await bluebird_lst_1.default.map((0, builder_util_2.walk)(appOutDir), file => {
        ...
        if (isScaledAssetsProvided(userAssets)) {
            ...
            await bluebird_lst_1.default.map(assetInfo.allAssets, it => (0, builder_util_2.copyOrLinkFile)(it, path.join(assetRoot, path.basename(it))));
